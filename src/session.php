<?php
	...
	require_once $PATH_ABSOLUTE."includes/session.inc.php";
?>
<html>
	<head>
	...
	<body>
		...
		<section id="one" class="wrapper">
			<h1 style="text-align:center"><?php echo $row['Date'].' | '.$row['StartTime'].' - '.$row['EndTime'];?></h1>
			<div class="container">
			<div id="modal" class="">
						...
						<form method="get" action="#">
							<div class="row uniform">
								<div class="9u 12u$(small)">
									<select name = "SessionID" id = "option">
										<?php option(); ?>
									</select>
								</div>
		...
		$( "#option" ) .change(function () {
			...
			window.location.assign("?SessionID="+$(this).val());
		});
		</script>
	</body>
</html>
