<?php
	...
	require_once $PATH_ABSOLUTE."includes/project.inc.php";
?>
<html>
	<head>
		<title>Project</title>
	...
	<body>
		...
		<h1 style="text-align:center"><?php echo strtoupper($row['Title']);?></h1>
			<div class="container">
			<div id="modal" class="">
						...
						<form method="get" action="#">
							<div class="row uniform">
								<div class="9u 12u$(small)">
									<select name = "ProjectID" id = "option">
										<?php option(); ?>
									</select>
								</div>
			...
			<h1 style="text-align:center">SCHEDULE</H1>
				...
				<h1 style="text-align:center">STUDENTS WITH <?php echo strtoupper($row['Title']);?> PROJECT</H1>
				<div class = "inner">
					<div class="table-wrapper">
						<table id="example" class="display" style="width:100%">
							<thead>
		...
		window.location.assign("?ProjectID="+$(this).val());
		});
		</script>
	</body>
</html>
