<?php
	...
	require_once $PATH_ABSOLUTE."includes/student.inc.php";
?>
<html>
	<head>
	...
	<body>
		...
		<section id="one" class="wrapper">
			<h1 style="text-align:center"><?php echo strtoupper($row['FirstName']).'  '.strtoupper($row['LastName']);?></h1>
			<div class="container">
			<div id="modal" class="">
						...
						<form method="get" action="#">
							<div class="row uniform">
								<div class="9u 12u$(small)">
									<select name = "StudentID" id = "option">
										<?php option(); ?>
									</select>
								</div>
		...
		$( "#option" ) .change(function () {
			...
			window.location.assign("?StudentID="+$(this).val());
		});
		</script>
	</body>
</html>
